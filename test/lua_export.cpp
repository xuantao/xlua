...
// allow export base type member
XLUA_EXPORT_CLASS_BEGIN(M_C_1)
XLUA_VARIATE(M_A_1::a_1)
XLUA_VARIATE(M_A_1::a_2)
XLUA_VARIATE(M_B_1::b_1)
XLUA_VARIATE(M_B_1::b_2)
XLUA_VARIATE(M_C_1::c_1)
XLUA_VARIATE(M_C_1::c_2)
XLUA_EXPORT_CLASS_END()

XLUA_EXPORT_CLASS_BEGIN(M_D_2)
XLUA_VARIATE(M_D_2::d_1)
XLUA_VARIATE(M_D_2::d_2)
XLUA_EXPORT_CLASS_END()

XLUA_EXPORT_CLASS_BEGIN(M_E_2, M_D_2)
XLUA_VARIATE(M_E_2::e_1)
XLUA_VARIATE(M_E_2::e_2)
XLUA_EXPORT_CLASS_END()

XLUA_EXPORT_CLASS_BEGIN(M_F_2, M_D_2)
XLUA_VARIATE(M_F_2::f_1)
XLUA_VARIATE(M_F_2::f_2)
XLUA_EXPORT_CLASS_END()

XLUA_EXPORT_CLASS_BEGIN(M_G_2, M_F_2)
XLUA_VARIATE(M_A_2::a_1)
XLUA_VARIATE(M_A_2::a_2)
XLUA_VARIATE(M_C_2::c_1)
XLUA_VARIATE(M_C_2::c_2)
XLUA_VARIATE(M_G_2::g_1)
XLUA_VARIATE(M_G_2::g_2)
XLUA_EXPORT_CLASS_END()
